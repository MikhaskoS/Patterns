...
{
    // Задача: преобразовать строковые данные в ООП структуру.
    // Пример - разбор математического выражeния.
    // Сначала выполняется синтаксический разбор (lexing) - строка разбивается на токены
    // Затем разбираем токены в ООП структуры (parsing)
    public class Demo
    {
